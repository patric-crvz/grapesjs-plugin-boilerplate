  ...
  if (c.blocks.indexOf(hNavbarRef) >= 0) {
    bm.add(hNavbarRef, {
      script: function() {
        ...
        fileref.setAttribute("href", 'https://cdnjs.cloudflare.com/ajax/libs/slick-carousel/1.8.1/slick.css');
        $('head').append(fileref);

        fileref = document.createElement("link");
        fileref.setAttribute("rel", "stylesheet");
        fileref.setAttribute("type", "text/css");
        fileref.setAttribute("href", 'https://cdnjs.cloudflare.com/ajax/libs/slick-carousel/1.8.1/slick-theme.css');
        $('head').append(fileref);
      ...
      content: `
      <div class="fade" data-gjs-droppable="true" data-gjs-custom-name="${c.labelNavbar}" data-gjs="${navbarRef}">
        <div data-gjs-droppable="true" data-gjs-draggable="false"
          data-gjs-removable="true" data-gjs-copyable="true" data-gjs-highlightable=1>your content 1</div>
        <div data-gjs-droppable="true" data-gjs-draggable="false"
          data-gjs-removable="true" data-gjs-copyable="true" data-gjs-highlightable=1>your content 2</div>
        <div data-gjs-droppable="true" data-gjs-draggable="false"
          data-gjs-removable="true" data-gjs-copyable="true" data-gjs-highlightable=1>your content 3</div>
      </div>
      `,
